...
1. Run `npm install`
1. Run `grunt install`
2. Create a branch (`git checkout -b improvementName`)
3. Commit your changes (`git commit -am "Added Gulp version"`)
4. Push to the branch (`git push origin improvementName`)
5. Open a [Pull Request](https://github.com/uglow/grunt-modular-project/pulls)
6. Reminisce about the hours you wasted watching [Lost](http://en.wikipedia.org/wiki/Lost_%28TV_series%29) and relax knowing that it won't take as long to merge the pull request.
